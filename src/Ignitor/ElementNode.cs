...
namespace Ignitor
{
    internal class ElementNode : ContainerNode
    {
        ...
        public async Task ClickAsync(HubConnection connection, string baseUri)
        {
            ...
            else if (Attributes.TryGetValue("href", out var href))
            {
                ...
                await connection.InvokeAsync("BeginInvokeDotNetFromJS", "0", assemblyName, methodIdentifier, 0, locationChangedArgs);
            }

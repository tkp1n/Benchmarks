...
namespace BenchmarksBot
{
    ...
    public class Tags
    {
        public static readonly Dictionary<string, Tags> Scenarios = new Dictionary<string, Tags>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            {"^MvcJsonInput100k$", new Tags { Labels = new [] { "area-mvc" } } },
            {"^MvcJsonOutput100k$", new Tags { Labels = new [] { "area-mvc" } } },
            {"^MvcJsonNetInput100k$", new Tags { Labels = new [] { "area-mvc" } } },
            {"^MvcJsonNetOutput100k$", new Tags { Labels = new [] { "area-mvc" } } },
